...
def main():
    ...
    input_model_path = "models/resnet_trained_for_cifar10.onnx/quark_model.onnx"

    # `output_model_path` is the path where the quantized model will be saved.
    output_model_path = "models/resnet_trained_for_cifar10.onnx/resnet.qdq.U8S8.onnx"
    ...
    quant_config = get_default_config("XINT8")  # Optimized to NPU
